package com.algorithm2026.programers2.day011;

import java.util.*;

public class Example20260524_Q258709 { //주사위 고르기
    public static int[] Example20260524_Q258709(int[][] dices) {
        int n = dices.length;
        int half = n / 2;
