package com.algorithm2026.programers2.day03;

public class Example20260503_Q49995 { //코딩테스트 연습 Summer/Winter Coding(~2018) 쿠키 구입
    public int Example20260503_Q49995(int[] cookie) {
        int answer = 0;
        int n = cookie.length;
