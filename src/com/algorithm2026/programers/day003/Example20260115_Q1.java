package com.algorithm2026.programers.day003;

import java.util.*;

public class Example20260115_Q1 { //2023 KAKAO BLIND RECRUITMENT 1,2,3 떨어트리기
    ...
    public static int[] Example20260115_Q1(int[][] edges, int[] target) {
