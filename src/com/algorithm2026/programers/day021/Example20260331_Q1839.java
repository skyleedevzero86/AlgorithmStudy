package com.algorithm2026.programers.day021;

import java.util.*;

public class Example20260331_Q1839 { //코딩테스트 연습 2017 카카오코드 본선 튜브의 소개팅
    ...
    public int[] Example20260331_Q1839(int m, int n, int s, int[][] time_map) {
        //초기화
        int[] dx = {0,0,1,-1};
        int[] dy = {1,-1,0,0};
        int[][] chk = new int[m][n];
