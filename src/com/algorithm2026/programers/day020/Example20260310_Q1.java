package com.algorithm2026.programers.day020;

import java.util.*;

public class Example20260310_Q1 { //Summer/Winter Coding(~2018) 햣지형 편집

    int[][] land;
    int P,Q;
    int N;

    public long Example20260310_Q1(int[][] land, int P, int Q) {
        long answer = 0;
