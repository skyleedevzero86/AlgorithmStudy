package com.algorithm2026.programers.day023;

public class Example20260414_Q12984 { //코딩테스트 연습 Summer/Winter Coding(~2018) 지형 편집
    int[][] land;
    int P,Q;
    int N;

    public long Example20260414_Q12984(int[][] land, int P, int Q) {
        long answer = 0;
