package com.algorithm2025.backjoon3.day013;

import java.util.*;

public class Example20250803_Q1 { // 코딩테스트 연습 2024 KAKAO WINTER INTERNSHIP  n + 1 카드게임
    ...
    public static int Example20250803_Q1(int coin, int[] cards) {
        int answer = 0;
        n = cards.length;
        coinCount = coin;
        player.clear();
