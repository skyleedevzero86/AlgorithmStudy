package com.algorithm2025.backjoon3.day012;

import java.util.Comparator;
import java.util.PriorityQueue;

public class Example20250801_Q1 { //코딩테스트 연습 PCCP 기출문제 [PCCP 기출문제] 4번 / 수레 움직이기
    public static int Example20250801_Q1(int[][] maze) {
        int answer = 0;
