package com.algorithm2025.backjoon3.day008;

import java.util.Arrays;

public class Example20250724_Q1843 { // 코딩테스트 연습 동적계획법(Dynamic Programming) 사칙연산

    public  int Example20250724_Q1843(String[] arr) {
        int n = arr.length;
