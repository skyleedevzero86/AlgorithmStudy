package com.algorithm2025.backjoon3.day018;

import java.util.Arrays;

public class Example20250814_Q118668 { //코딩테스트 연습 2022 KAKAO TECH INTERNSHIP 코딩 테스트 공부


    public static int Example20250814_Q118668(int alp, int cop, int[][] problems) {
