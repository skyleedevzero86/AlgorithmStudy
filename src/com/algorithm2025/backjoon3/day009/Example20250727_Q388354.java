package com.algorithm2025.backjoon3.day009;
...
class Example20250727_Q388354 { //코딩테스트 연습 2025 프로그래머스 코드챌린지 1차 예선 홀짝트리 복습

    public int[] Example20250727_Q388354(int[] nodes, int[][] edges) {
