package com.algorithm2025.backjoon3.day016;

import java.util.ArrayList;
import java.util.LinkedList;
import java.util.Queue;

public class Example20250806_Q76503 { //코딩테스트 연습  월간 코드 챌린지 시즌2 모두 0으로 만들기

    public long Example20250806_Q76503(int[] a, int[][] edges) {
        long answer = 0, sum = 0;
