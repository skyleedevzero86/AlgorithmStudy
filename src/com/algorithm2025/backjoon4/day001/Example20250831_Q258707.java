package com.algorithm2025.backjoon4.day001;

import java.util.*;

public class Example20250831_Q258707 { // 코딩테스트 연습 2024 KAKAO WINTER INTERNSHIP  n + 1 카드게임 복습
    ...
    public static int Example20250831_Q258707(int coin, int[] cards) {
        int answer = 0;
        n = cards.length;
        coinCount = coin;
        player.clear();
