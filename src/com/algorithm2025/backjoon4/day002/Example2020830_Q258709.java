package com.algorithm2025.backjoon4.day002;

import java.util.*;

public class Example2020830_Q258709 { //코딩테스트 연습2024 KAKAO WINTER INTERNSHIP 주사위 고르기
    public static int[] Example2020830_Q258709(int[][] dices) {
        int n = dices.length;
        int half = n / 2;
