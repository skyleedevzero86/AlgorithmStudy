package com.algorithm2025.backjoon4.day013;

import java.util.ArrayList;
import java.util.List;

public class Example20251020_Q150366 { //코딩테스트 연습 2023 KAKAO BLIND RECRUITMENT 표 병합
    ...
    public Example20251020_Q150366() {
        for (int r = 0; r < 51; r++) {
            for (int c = 0; c < 51; c++) {
