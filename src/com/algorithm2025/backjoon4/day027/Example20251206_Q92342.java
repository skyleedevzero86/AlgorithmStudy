package com.algorithm2025.backjoon4.day027;

public class Example20251206_Q92342 {// 2022 KAKAO BLIND RECRUITMENT 양궁대회

    static int N, maxMinus;
    static int[] arr;
    static int[] answer = {-1};
    public int[] Example20251206_Q92342(int n, int[] info) {
        N = n;
        maxMinus = -1;
        arr = new int[11];
        dfs(info, 0, 0);
