package com.algorithm2025.backjoon4.day009;

import java.util.ArrayList;
import java.util.List;

public class Example20250927_Q17676 { //코딩테스트 연습 2024 KAKAO WINTER INTERNSHIP 도넛과 막대 그래프
    ...
    public int[] Example20250927_Q17676(int[][] edges) {
