package com.algorithm2025.backjoon2.day020;

import java.util.ArrayList;
import java.util.List;
import java.util.PriorityQueue;

public class Example20250517_Q81304 {
    ...
    public int Example20250517_Q81304(int n, int start, int end, int[][] roads, int[] traps) {
        // d값을 INF로 초기화
        for(int i = 1; i <= n; i++){
