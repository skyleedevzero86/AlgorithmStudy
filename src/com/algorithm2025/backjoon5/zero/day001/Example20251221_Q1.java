package com.algorithm2025.backjoon5.zero.day001;

public class Example20251221_Q1 { //코딩테스트 연습 2023 현대모비스 알고리즘 경진대회 예선  경사로의 개수
    ...
    public static int Example20251221_Q1(int[][] grid, int[] D, int k) {
        int N = grid.length;
        int M = grid[0].length;
        int L = N * M;
